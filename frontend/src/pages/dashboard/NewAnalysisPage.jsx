  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between relative mb-12">
        ...
        <div 
          className="absolute left-0 top-[16px] -translate-y-1/2 h-1 bg-[var(--accent)] z-0 transition-all duration-500 ease-in-out rounded-full shadow-[0_0_10px_rgba(79,70,229,0.5)]" 
